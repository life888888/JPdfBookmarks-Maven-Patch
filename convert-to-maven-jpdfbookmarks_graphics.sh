...
#### module jpdfbookmarks_graphics ####
# Create Maven Standard Directory Layout
mkdir -p $BASE/jpdfbookmarks_graphics/src/main/java
mkdir -p $BASE/jpdfbookmarks_graphics/src/main/resources

# module jpdfbookmarks_graphics
cd $BASE/jpdfbookmarks_graphics/src
...
# so delete them all 
cd $BASE/jpdfbookmarks_graphics/src/main/resources/
...
# so delete them 
cd $BASE/jpdfbookmarks_graphics/src/main/java/
...
cd $BASE/jpdfbookmarks_graphics/
rm -R nbproject
rm -R test
rm build.xml
# rm -R artwork
