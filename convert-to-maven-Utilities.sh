...
mkdir -p $BASE/Utilities/src/main/java
mkdir -p $BASE/Utilities/src/main/resources

# module Utilities
cd $BASE/Utilities/src
...
# so delete them all 
cd $BASE/Utilities/src/main/resources/
...
# so delete them 
cd $BASE/Utilities/src/main/java/
